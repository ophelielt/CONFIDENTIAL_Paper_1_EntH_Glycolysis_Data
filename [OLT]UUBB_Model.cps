...
<!-- generated with COPASI 4.24 (Build 197) (http://www.copasi.org) at 2019-02-12 05:05:27 UTC -->
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Function_41">
    ...
    <Function key="Function_42" name="PPDK_UUBB_Marcela-Gomez et al. (2004)" type="UserDefined" reversible="true">
      <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Function_42">
    <dcterms:created>
      ...
      <Expression>
        (Vf*Vr*((A*B*C)-((P*Q*R)/Keq)))/((Vr*Kib*Kc*A)+(Vr*Kc*A*B)+(Vr*Kb*A*C)+((Vf/Keq)*Kir*Kq*P)+((Vf/Keq)*Kr*P*Q)+(Vr*Kib*(Kc/Kiq)*A*Q)+((Vf/Keq)*Kq*P*R)+((Vf/Keq)*Kp*Q*R)+((Vf/Keq)*Kq*P*R)+(Vr*Ka*B*C)+((Vf/Keq)*((Kir*Kq)/Kic)*C*P)+(Vr*(Kc/Kiq)*A*B*Q)+((Vf/Keq)*(Kr/Kia)*A*P*Q)+((Vf/Keq)*(Kp/Kib)*B*Q*R)+(Vr*(Ka/Kip)*A*C*P)+(Vr*(Ka/Kir)*B*C*R)+((Vf/Keq)*(Kp/Kib)*B*Q*R)+(Vr*(Kc/(Kiq*Kiic))*A*B*C*Q)+((Vf/Keq)*(Kq/Kic)*C*P*R)+((Vf/Keq)*(Kq/(Kic*Kiiq))*C*P*R)+(Vr*(Ka/(Kir*Kiic))*B*C*Q*R)+(Vr*A*B*C)+((Vf/Keq)*P*Q*R)+((Vf/Keq)*((Kir*Kq)/Kia)*A*P))
      </Expression>
      <ListOfParameterDescriptions>
        ...
        <ParameterDescription key="FunctionParameter_293" name="Kib" order="15" role="constant"/>
        <ParameterDescription key="FunctionParameter_294" name="Kir" order="16" role="constant"/>
        <ParameterDescription key="FunctionParameter_295" name="Kiq" order="17" role="constant"/>
        <ParameterDescription key="FunctionParameter_296" name="Kic" order="18" role="constant"/>
        <ParameterDescription key="FunctionParameter_297" name="Kia" order="19" role="constant"/>
        <ParameterDescription key="FunctionParameter_298" name="Kip" order="20" role="constant"/>
        <ParameterDescription key="FunctionParameter_299" name="Kiic" order="21" role="constant"/>
        <ParameterDescription key="FunctionParameter_300" name="Kiiq" order="22" role="constant"/>
      </ListOfParameterDescriptions>
    </Function>
  </ListOfFunctions>
    ...
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_4997" name="Kq" value="1342"/>
          <Constant key="Parameter_4996" name="Vr" value="12.28"/>
          <Constant key="Parameter_4995" name="Kp" value="221"/>
          <Constant key="Parameter_4994" name="Kr" value="597"/>
          <Constant key="Parameter_4993" name="Kib" value="1000"/>
          <Constant key="Parameter_4992" name="Kir" value="140"/>
          <Constant key="Parameter_4991" name="Kiq" value="23000"/>
          <Constant key="Parameter_4990" name="Kic" value="1000"/>
          <Constant key="Parameter_4989" name="Kia" value="1000"/>
          <Constant key="Parameter_4988" name="Kip" value="2300"/>
          <Constant key="Parameter_4987" name="Kiic" value="1000"/>
          <Constant key="Parameter_4986" name="Kiiq" value="7200"/>
        </ListOfConstants>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_3">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4985" name="k1" value="2000"/>
        </ListOfConstants>
      ...
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=Lower Glycolysis pH6 WITH Inhibition,Vector=Reactions[PPDK]" type="Reaction">
            ...
            <ModelParameter cn="CN=Root,Model=Lower Glycolysis pH6 WITH Inhibition,Vector=Reactions[PPDK],ParameterGroup=Parameters,Parameter=Kib" value="1000" type="ReactionParameter" simulationType="fixed"/>
            ...
            <ModelParameter cn="CN=Root,Model=Lower Glycolysis pH6 WITH Inhibition,Vector=Reactions[PPDK],ParameterGroup=Parameters,Parameter=Kic" value="1000" type="ReactionParameter" simulationType="fixed"/>
            <ModelParameter cn="CN=Root,Model=Lower Glycolysis pH6 WITH Inhibition,Vector=Reactions[PPDK],ParameterGroup=Parameters,Parameter=Kia" value="1000" type="ReactionParameter" simulationType="fixed"/>
            ...
            <ModelParameter cn="CN=Root,Model=Lower Glycolysis pH6 WITH Inhibition,Vector=Reactions[PPDK],ParameterGroup=Parameters,Parameter=Kiic" value="1000" type="ReactionParameter" simulationType="fixed"/>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_15" name="Time-Course" type="timeCourse" scheduled="false" updateModel="false">
      <Report reference="Report_19" target="6_Rebuilt_LowerGlycolysis_COPASI_UUBB_Fig2_Outputs/6_Rebuilt_UUBB_Fig2_Concentrations.txt" append="1" confirmOverwrite="1"/>
      <Problem>
